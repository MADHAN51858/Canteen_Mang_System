...
export default function Menu() {
  ...
  const canAddProduct = rawRole.includes("admin") || rawRole.includes("staff");
      ...
      <Container maxWidth="lg">
        ...
        >
          ...
          <Stack direction="row" alignItems="center" spacing={2} sx={{ zIndex: 1 }}>
            ...
            <Box>
              <Typography variant="h3" fontWeight={900} sx={{ fontSize: { xs: "1.75rem", sm: "2.5rem" }, color: "white", lineHeight: 1 }}>
                {canAddProduct ? "Menu Management" : "Menu"}
              </Typography>
          ...
          {canAddProduct && (
            <Button
              variant="contained"
              startIcon={<AddCircleOutlineRoundedIcon sx={{ fontSize: 20 }} />}
